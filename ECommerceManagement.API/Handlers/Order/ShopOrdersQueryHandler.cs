...
public class ShopOrdersQueryHandler : BaseHandler<ShopOrdersQuery, ListObject<OrderInfoObject>>
{
    public ShopOrdersQueryHandler(EcommerceContext context) : base(context)
    {
    }

    public override async Task<ListObject<OrderInfoObject>> Handle(ShopOrdersQuery request, CancellationToken cancellationToken)
    {
        var orders = _context.Orders.AsNoTracking()
            .Include(o => o.Address)
            .Include(o => o.OrderProducts)
            .Where(o => o.ShopId == request.Id);
